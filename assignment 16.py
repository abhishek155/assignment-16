...
conn.execute("INSERT INTO Publishers(PUBLISHERID,NAME,STREETADDRESS,SUITENUMBER,ZIPCODEID) VALUES(130,'ABHISHEK','STREET NO 32 California',246,1555)")
...
conn.execute("INSERT INTO Authors(AUTHORID,FIRSTNAME,MIDDLENAME,LASTNAME) VALUES(199,'ABHISHEK',NULL,'KASHYAP')")
conn.commit()
